...
namespace Ocacho::Physics::RigidBody
{
	...
	struct CollisionData
	{
		...
		std::array<Contact, 100> contactList_;
	...
	struct CollisionPrimitive
	{
		...
		friend struct IntersectionTests;
	...
	struct CollisionDetector
	{
		...
		//=====================================================================
			...
			Vector3 closestPtSpheretoBox(const Vector3& p_sphereCenter
				, const Vector3& p_boxCenter, const Vector3& p_boxHalfSize) const noexcept;
	...
	struct IntersectionTests
	{
		...
		static bool boxAndSphere(const CollisionBox& p_box, const CollisionSphere& p_sphere) noexcept;
		...
		static bool boxAndBox(const CollisionBox& p_first, const CollisionBox& p_second) noexcept;

		static bool overlapOnAxis(const CollisionBox& p_first, const CollisionBox& p_second
			, const Vector3& p_axis, const Vector3& p_toCentre) noexcept;
		
		static float transformToAxis(const CollisionBox& p_box, const Vector3& p_axis) noexcept;
	};
}